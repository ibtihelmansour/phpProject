...
/* FIX ECOMBSKA-9501 */
angular.module("itxApp").factory("bskGridImages", ["$log", "bskGridState", "bskImageConstants", "gridFormatManager", "formatManagerConstants", "bskVideoHelperFactory", function($log, state, imageConstants, formatManager, formatConstants, videoHelper) {
	...
	var factory = {
		...
		getImages: function(product, color) {
			var images = this.getTypeGroup(product, color)[state.imageSize] || [];
