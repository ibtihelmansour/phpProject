 ...
 <?php 
    ...
    ?>
				...
				<div class="row">
						...
						<h4 class="mtext-105 cl2 js-name-detail p-b-14" style=" font-size: 25px ; letter-spacing: 3px ;">
							...
							<div class="p-t-33">
								<div class="flex-w flex-r-m p-b-10" style="margin-right: 55%">
									<div class="size-203 flex-c-m respon6" style="margin-right: 65%">
										Size disponible 
									</div>
                    ...
                    <li class='page-item'>
                        <a class='page-link' style="background-color: grey" >38</a>
                    </li>
                    <li class='page-item'>
                        <a class='page-link' >39</a>
                    </li>
                    <li class='page-item'>
                        <a class='page-link' style="background-color: grey">40</a>
                    </li>
                    <li class='page-item'>
                        <a class='page-link' >41</a>
                    </li>
                </ul>
								</div>
						        ...
						        <div class="shiopping-grids d-lg-flex">
						            <div class="shiopping-w3pvt-gd text-center">
						            ...
						            <div class="shiopping-w3pvt-gd sec text-center">
                                   ...
                                   <!--div  style="margin-right: 150px; padding: 70px 0;" >
