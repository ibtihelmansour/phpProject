  ...
  <form method="POST" action="dashboard.php">
             ...
             <div class="form-group row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text"  class="form-control"  name="titre"  id="desc" required>
                </div>

              </div>
                <span class="input-group-btn">
                <button href="" type="submit" name="insert" id="insert" class="btn  btn-success display-4" style="border-radius: 3rem" >Ajouter un produit
                </button>
              </span>
